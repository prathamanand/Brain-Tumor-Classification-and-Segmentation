Developed a deep learning pipeline using ResNet50 for classifying brain tumors in MRI images. Implemented a subsequent ResUnet model for segmenting the tumor region upon detection.
